...
var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div = element("div");
    			img = element("img");
    			if (img.src !== (img_src_value = /*backgroundImage*/ ctx[0])) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", "");
    			add_location(img, file, 6, 2, 103);
    			attr_dev(div, "class", "background");
    			add_location(div, file, 5, 1, 75);
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ backgroundImage });
